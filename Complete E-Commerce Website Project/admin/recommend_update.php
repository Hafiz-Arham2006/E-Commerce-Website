...
<div class="right">
          ...
          <table class="table">
            ...
            <tr>
              <td><input type="number" name="p_price" value="<?php echo $data['p_price'] ?>" class="form-control" placeholder="Product Name" required></td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td><input type="text" name="p_description" value="<?php echo $data['p_description'] ?>" class="form-control" placeholder="Product Name" required></td>
            </tr>
            <tr>
              <td>
                <h4>Update Image : </h4>
            ...
            <tr>
              <td><input type="file" name="p_img" value="<?php echo $data['p_img'] ?>" class="form-control" placeholder="Product Name" accept="./images*"></td>
            </tr>
            <tr>
        ...
        if (isset($_POST['update_btn'])) {
          ...
          if ($_FILES['p_img']['size'] > 0) {
            ...
            $obj->Update_Recommend($id,$p_name,$p_price,$p_description,$p_img);
          if ($obj) {
            echo "<script>alert('Product Updated to your Website Successfully ! ')</script>";
            echo "<script>window.location.href='recommend_products.php'</script>";
          }else{
