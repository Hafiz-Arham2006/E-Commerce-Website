    ...
    <div class="right">
      <div class="container">
        <table class="table text-center display-5">
          <tr>
            <th>Add Recommend Product</th>
          </tr>
        </table>
        <form method="post" enctype="multipart/form-data">
          <h4>Product Name : </h4><input type="text" class="form-control" placeholder="Product Name" name="p_name" required><br>
          <h4>Product Price : </h4><input type="number" class="form-control" placeholder="Product Price" name="p_price" required><br>
...
$obj->Add_Recommend_Products($p_name,$p_price,$p_description,$p_img);
if($obj){
